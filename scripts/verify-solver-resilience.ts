...
async function main() {
  ...
  const { alerts, auditEvents, durableJobs, projects, projectMembers, scheduleAssignments, scheduleEvents, scheduleTasks, scheduleVersions } = await import("../src/lib/db/schema");
