...
export default async function SourcesPage() {
  ...
  return <FeatureShell projectName={data.project} projectId={projectId} eyebrow="Controlled inputs" title="Sources" description="Upload immutable PDF revisions and inspect every extracted citation region.">
