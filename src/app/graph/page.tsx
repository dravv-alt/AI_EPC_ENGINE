...
export default async function GraphPage() {
  ...
  return <FeatureShell projectName={data.project} eyebrow="Connected context" title="Graph & timeline" description="Inspect and create project-scoped typed relationships, then trace every controlled mutation through the append-only audit timeline.">
